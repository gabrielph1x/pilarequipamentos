        ...
        <div className="max-w-7xl mx-auto space-y-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-6 space-y-4">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-pilar-charcoal leading-tight font-display">
            ...
            <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 sm:p-5 bg-pilar-bg rounded-2xl border border-pilar-border space-y-2 hover:border-pilar-terracotta transition-colors">
                <div className="w-9 h-9 bg-pilar-red text-white rounded-xl flex items-center justify-center font-bold">
                  <ShieldCheck className="w-5 h-5" />
                </div>
                <h3 className="font-extrabold text-sm text-pilar-charcoal font-display">Atendimento Técnico</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
                  Consultores qualificados para orientar a escolha perfeita para cada fase da sua obra.
                </p>
              </div>
              ...
              <div className="p-4 sm:p-5 bg-pilar-bg rounded-2xl border border-pilar-border space-y-2 hover:border-pilar-terracotta transition-colors">
                ...
                <h3 className="font-extrabold text-sm text-pilar-charcoal font-display">Frota Atualizada</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
                  Equipamentos novos dos melhores fabricantes, testados e higienizados.
                </p>
              </div>
              ...
              <div className="p-4 sm:p-5 bg-pilar-bg rounded-2xl border border-pilar-border space-y-2 hover:border-pilar-terracotta transition-colors">
                ...
                <h3 className="font-extrabold text-sm text-pilar-charcoal font-display">Manutenção In Loco</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
                  Assistência técnica ágil na obra e substituição imediata sem custo em caso de defeito.
                </p>
              </div>
              ...
              <div className="p-4 sm:p-5 bg-pilar-bg rounded-2xl border border-pilar-border space-y-2 hover:border-pilar-terracotta transition-colors">
                ...
                <h3 className="font-extrabold text-sm text-pilar-charcoal font-display">Entrega e Coleta</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
                  Logística rápida de entrega e recolhimento diretamente no local do seu projeto.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {CATEGORIES.map((category) => (
              <Link
                ...
                className="group relative bg-white rounded-2xl border border-pilar-border overflow-hidden shadow-pilar-sm hover:shadow-pilar-lg transition-all duration-300 flex flex-col justify-between"
              >
                ...
                <div className="p-5 relative z-10 space-y-2 -mt-10 bg-white rounded-t-2xl">
                  ...
                  <div className="pt-2 flex items-center text-xs font-bold text-pilar-red group-hover:underline gap-1">
        ...
        <div className="max-w-7xl mx-auto space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {COMPANY_INFO.units.map((unit) => (
              <div
                key={unit.id}
                className="bg-[#523132]/60 border border-pilar-terracotta/40 rounded-2xl p-5 sm:p-8 space-y-5 flex flex-col justify-between"
              >
