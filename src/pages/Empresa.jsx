      ...
      <div className="max-w-7xl mx-auto px-4 space-y-16">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Card Missão */}
            <div className="bg-white rounded-2xl p-8 border border-pilar-border shadow-pilar-sm space-y-4 hover:border-pilar-red transition-colors flex flex-col justify-between">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {COMPANY_INFO.motivosParaAlugarGrouped.map((group, gIdx) => {
              ...
              return (
                <div
                  key={gIdx}
                  className="bg-pilar-wine/50 border border-pilar-terracotta/40 rounded-2xl p-6 md:p-8 space-y-6"
                >
        ...
        <section className="bg-white rounded-2xl p-8 md:p-12 border border-pilar-border space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {COMPANY_INFO.units.map((unit) => (
              <div
                key={unit.id}
                className="bg-pilar-bg rounded-2xl p-6 border border-pilar-border space-y-4 flex flex-col justify-between"
              >
