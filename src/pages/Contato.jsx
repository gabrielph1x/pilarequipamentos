        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          {COMPANY_INFO.units.map((unit, idx) => (
            <ScrollReveal key={unit.id} direction="up" delay={idx * 120} duration={600} className="h-full">
              <div
                className="bg-white rounded-3xl border border-pilar-border shadow-pilar-md overflow-hidden flex flex-col justify-between h-full"
              >
                ...
                <div className="p-6 sm:p-8 flex-1 flex flex-col justify-between space-y-6">
                  ...
                  {/* Botão de WhatsApp por Unidade (Empurrado para a base do bloco superior com mt-auto) */}
                ...
                {/* Embed Google Maps da Unidade (Em cores originais sem grayscale) */}
